...
Use your brain! Don't push sensitive data (passwords, keys, etc.[1]) to github and you'll be happy. Also use your own account information for setup[2].
...
"Continue":http://github.com/Inte/cobagi/tree/master
